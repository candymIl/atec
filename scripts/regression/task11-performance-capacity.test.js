...
assert(serverSource.includes('const equipgroupid = String(req.query.equipgroupid'))
assert(serverSource.includes('const equiptypeid = String(req.query.equiptypeid'))
assert(serverSource.includes('et.equipgroupid = $'))
assert(serverSource.includes('a.equiptypeid = $'))
...
assert(mainSource.includes('filterAssetEquipmentGroup'))
assert(mainSource.includes('filterAssetEquipmentType'))
assert(assetPageSource.includes('Equipment Group'))
assert(assetPageSource.includes('Equipment List'))
...
assert(certificatePageSource.includes('class="certificate-worklist '))
assert(certificatePageSource.includes('class="certificate-worklist-row"'))
assert(certificatePageSource.includes('class="certificate-row-summary"'))
assert(certificatePageSource.includes('class="certificate-worklist-details"'))
assert(certificatePageSource.includes('class="certificate-worklist-actions"'))
assert(certificatePageSource.includes("const toggleDetails = button =>"))
assert(certificatePageSource.includes('class="bulk-certificate-worklist-row"'))
assert(certificatePageSource.includes('class="bulk-certificate-primary"'))
assert(certificatePageSource.includes('class="bulk-cert-check"'))
assert(frontendStyleSource.includes(".certificate-worklist-header"))
assert(frontendStyleSource.includes(".certificate-row-summary"))
assert(frontendStyleSource.includes(".bulk-certificate-worklist-header"))
assert(frontendStyleSource.includes("@container bulk-certificate-results"))
assert(frontendStyleSource.includes("position: sticky;"))
assert(frontendStyleSource.includes("grid-template-columns: repeat(2, minmax(0, 1fr));"))
