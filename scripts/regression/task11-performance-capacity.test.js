...
assert(certificatePageSource.includes('class="certificate-search-table '))
assert(certificatePageSource.includes('class="certificate-table-scrollbar-top '))
assert(certificatePageSource.includes("function bindCertificateTableScrollbars()"))
assert(certificatePageSource.includes("topScrollbar.addEventListener('scroll'"))
assert(certificatePageSource.includes("tableRegion.addEventListener('scroll'"))
assert(certificatePageSource.includes('class="certificate-col-job-number"'))
assert(certificatePageSource.includes('class="certificate-asset-cell"'))
assert(certificatePageSource.includes('class="certificate-serial-cell"'))
assert(frontendStyleSource.includes("#certificateResults table.certificate-search-table"))
assert(frontendStyleSource.includes(".certificate-table-scrollbar-top"))
assert(frontendStyleSource.includes(".certificate-table-scroll-region"))
assert(frontendStyleSource.includes("min-width: 1380px !important;"))
