...
assertIncludes(frontend, "window.startDashboardNfcScan", "Dashboard NFC scanner is missing")
assertIncludes(dashboard, "Scan NFC Tag", "Dashboard must offer NFC scanning in Quick Asset Search")
assertIncludes(dashboard, "dashboardNfcStatus", "Dashboard must show NFC scan status and browser guidance")
