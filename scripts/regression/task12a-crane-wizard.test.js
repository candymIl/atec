...
assertIncludes(frontendMain, "myProfileSignatureCanvas", "My Profile must provide a direct signature drawing pad")
assertIncludes(frontendMain, "saveMyDrawnSignature", "Users must be able to save a signature drawn on the profile page")
assertIncludes(frontendMain, "Save drawn signature", "The direct signature save action must be clear to users")
