...
assertIncludes(main, "managementMode === 'internal' ? `<th>${userSortHeader('Section Name', 'sectionid')}</th>` : ''", "Section column must be hidden for customer portal users")
assertIncludes(main, "sectionid: managementMode === 'customers'", "Customer portal user saves must clear section scope")
