...
assertIncludes(style, ".dashboard-notification-worklist", "The compact notification worklist styles are missing")
...
assertIncludes(style, ".dashboard-notification-worklist-row", "Compact notification rows are missing")
