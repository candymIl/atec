...
async function main() {
  ...
  assert(serverSource.includes('app.get("/dashboard/visual-due"'))
  assert(serverSource.includes("latest_visual.validdate < CURRENT_DATE"))
  assert(!serverSource.includes('res.json({ total: 0 })'))
